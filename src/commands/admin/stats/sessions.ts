import { ActionRowBuilder, ApplicationCommandOptionType, AttachmentBuilder, ButtonBuilder, ButtonStyle, CommandInteraction, EmbedBuilder, MessageFlags } from "discord.js";
...
export class AdminStatsSessions {
  ...
  async sessions(
    ...
    const chartPop = new Chart(ctxPop as any, {
      type: "bar",
      data: {
    ...
    const chartAct = new Chart(ctxAct as any, {
